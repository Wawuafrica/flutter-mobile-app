...
class OtpScreen extends StatefulWidget {
  ...
  /// Optional: if provided, used to determine custom navigation after OTP verification
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  Future<void> _handleVerifyOtp() async {
    ...
    try {
      ...
      // After OTP verification, determine navigation based on optional nextScreen param.
      if (mounted) {
